...
class Crud_sesion extends TPage
{
	...
	public function deleteItem($sender,$param)
    {
	    ...
	    $this->alertas->Text = '';
		 ...
		 try {
			...
			$this->agregar_mensajes_unicode(SesionesRecord::finder()->deleteByPk($this->DataList->DataKeys[$param->Item->ItemIndex]),'Eliminar sesión',true);
						
		 } catch (Exception $e) {
                
				$this->agregar_mensajes_unicode(false,'Compruebe que la sesión que intenta eliminar
				no se encuentra programada. Deberá eliminar las programaciones primero',false);	
         }	
	...
	public function updateItem($sender,$param)
    {
		...
		$this->agregar_mensajes_unicode($datosSesiones->save(),'Editar sesión',true);
